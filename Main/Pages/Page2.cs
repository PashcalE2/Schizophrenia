...
namespace Schizophrenia.Main.Pages
{
    public class Page2 : AnyPage
    {
        ...
        public Page2(AppForm appForm) : base(appForm)
        {
            ...
            HB1TextBox = new InputTextBox<double>("HB1TextBox", Validators.DefaultDoubleValidator, (value) => appForm.HB1 = value);
            page2TableLayout.Add(HB1TextBox, 5, 1);

            HB2TextBox = new InputTextBox<double>("HB2TextBox", Validators.DefaultDoubleValidator, (value) => appForm.HB2 = value);
            page2TableLayout.Add(HB2TextBox, 5, 2);

            HRCLabel = new MyLabel("HRCLabel", "по шкале Роквелла, HRC");
            page2TableLayout.Add(HRCLabel, 6, 0);

            HRC1TextBox = new InputTextBox<double>("HRC1TextBox", Validators.DefaultDoubleValidator, (value) => appForm.HRC1 = value);
            page2TableLayout.Add(HRC1TextBox, 6, 1);

            HRC2TextBox = new InputTextBox<double>("HRC2TextBox", Validators.DefaultDoubleValidator, (value) => appForm.HRC2 = value);
            page2TableLayout.Add(HRC2TextBox, 6, 2);

            HVLabel = new MyLabel("HVLabel", "по шкале Виккерса, HV");
            page2TableLayout.Add(HVLabel, 7, 0);

            HV1TextBox = new InputTextBox<double>("HV1TextBox", Validators.DefaultDoubleValidator, (value) => appForm.HV1 = value);
            page2TableLayout.Add(HV1TextBox, 7, 1);

            HV2TextBox = new InputTextBox<double>("HV2TextBox", Validators.DefaultDoubleValidator, (value) => appForm.HV2 = value);
            ...
            HRCs1TextBox = new InputTextBox<double>("HRCs1TextBox", Validators.DefaultDoubleValidator, (value) => appForm.HRCs1 = value);
            page2TableLayout.Add(HRCs1TextBox, 8, 1);

            HRCs2TextBox = new InputTextBox<double>("HRCs2TextBox", Validators.DefaultDoubleValidator, (value) => appForm.HRCs2 = value);
